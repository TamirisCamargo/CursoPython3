...
if n_inteiro.isdigit():
    ...
    if n_inteiro % 2 == 0:
        print(f'{n_inteiro} é par')
    else:
        print(f'{n_inteiro} é ímpar')
else:
    print(f'"{n_inteiro}" não é um número inteiro.')
...
"""Faça um programa que peça o primeiro nome do usuário. Se o nome tiver 4 letras ou menos escreva "Seu nome é 
curto"; se tiver entre 5 e 6 letras, escreva "Seu nome é normal"; maior que 6 escreva "Seu nome é muito grande". 
"""
